...
import it.zazos.cors.filter.IE8XDomainRequestFilter;
...
public class ApplicationConfig {
    ...
    public FilterRegistrationBean createIE8XDomainRequestFilter() {
        FilterRegistrationBean registrationBean =
                new FilterRegistrationBean();
        registrationBean.setFilter(new IE8XDomainRequestFilter());
